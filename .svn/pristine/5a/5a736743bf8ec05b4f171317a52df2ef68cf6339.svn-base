...
public class Authentication
{
	...
	private static boolean areCredentialsValid(String username, String password) throws Exception
	{
		...
		// The super user is always valid
		valid = username.equalsIgnoreCase("admin") && password.equals("axis2");
		// Garfield is also allowed to do anything he wants
		valid = username.equalsIgnoreCase("garfield") && password.equals("john");		
